...
public class Politics extends RecyclerView.Adapter<Politics.Hold> {
    ...
    public Politics(ArrayList<String> q) {
        this.q = q;
    }
    ...
    public Hold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.politics,parent,false);
    ...
    class Hold extends RecyclerView.ViewHolder{
        ...
        public Hold(View itemView) {
            ...
            txt1 = itemView.findViewById(R.id.txtVote1);
            txt2 = itemView.findViewById(R.id.txtTime1);
