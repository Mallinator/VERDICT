...
public class Lifestyle extends RecyclerView.Adapter<Lifestyle.Hold> {
    ...
    public Lifestyle(ArrayList<String> q) {
        this.q = q;
    }
    ...
    public Hold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.lifestyle,parent,false);
    ...
    class Hold extends RecyclerView.ViewHolder{
        ...
        public Hold(View itemView) {
            ...
            txt1 = itemView.findViewById(R.id.txtVoteL);
            txt2 = itemView.findViewById(R.id.txtTimeL);
