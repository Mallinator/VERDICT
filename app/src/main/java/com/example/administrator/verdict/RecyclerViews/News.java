...
public class News extends RecyclerView.Adapter<News.Hold> {
    ...
    public News(ArrayList<String> q) {
        this.q = q;
    }
    ...
    class Hold extends RecyclerView.ViewHolder{
        ...
        public Hold(View itemView) {
            ...
            txt1 = itemView.findViewById(R.id.txtVoteN);
            txt2 = itemView.findViewById(R.id.txtTimeN);
