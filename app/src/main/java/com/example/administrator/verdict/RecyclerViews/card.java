...
public class card extends RecyclerView.Adapter <card.hold> {
    ...
    public card(ArrayList<String> q) {
        this.q = q;
    }
   ...
   /* public void voteCount(String s){
...
*/
    ...
    class hold extends RecyclerView.ViewHolder{
        ...
        public hold(View itemView) {
            ...
            txt1 = itemView.findViewById(R.id.txtVote);
            txt2 = itemView.findViewById(R.id.txtTime);
