...
public class Technology extends RecyclerView.Adapter<Technology.Hold> {
    ...
    public Technology(ArrayList<String> q) {
        this.q = q;
    }
    ...
    public Hold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.technology,parent,false);
    ...
    class Hold extends RecyclerView.ViewHolder{
        ...
        public Hold(View itemView) {
            ...
            txt1 = itemView.findViewById(R.id.txtVotet);
            txt2 = itemView.findViewById(R.id.txtTimet);
